...
var ENDSHOW_MESG="Fim da apresentação de slides. Clique para sair.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=35, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscrn.htm";
...
var gDocTable = new Array(
   new hrefList("s0001.htm", 1, 1),
   new hrefList("s0017.htm", 1, 2),
   new hrefList("s0015.htm", 1, 3),
   new hrefList("s0016.htm", 1, 4),
   new hrefList("s0014.htm", 1, 5),
   new hrefList("s0019.htm", 1, 6),
   new hrefList("s0013.htm", 1, 7),
   new hrefList("s0012.htm", 1, 8),
   new hrefList("s0018.htm", 1, 9),
   new hrefList("s0020.htm", 1, 10),
   new hrefList("s0022.htm", 1, 11),
   new hrefList("s0021.htm", 1, 12),
   new hrefList("s0023.htm", 1, 13),
   new hrefList("s0024.htm", 1, 14),
   new hrefList("s0025.htm", 1, 15),
   new hrefList("s0026.htm", 1, 16),
   new hrefList("s0027.htm", 1, 17),
   new hrefList("s0028.htm", 1, 18),
   new hrefList("s0029.htm", 1, 19),
   new hrefList("s0030.htm", 1, 20),
   new hrefList("s0031.htm", 1, 21),
   new hrefList("s0032.htm", 1, 22),
   new hrefList("s0033.htm", 1, 23),
   new hrefList("s0034.htm", 1, 24),
   new hrefList("s0035.htm", 1, 25),
   new hrefList("s0036.htm", 1, 26),
   new hrefList("s0037.htm", 1, 27),
   new hrefList("s0038.htm", 1, 28),
   new hrefList("s0040.htm", 1, 29),
   new hrefList("s0045.htm", 1, 30),
   new hrefList("s0039.htm", 1, 31),
   new hrefList("s0041.htm", 1, 32),
   new hrefList("s0042.htm", 1, 33),
   new hrefList("s0043.htm", 1, 34),
   new hrefList("s0044.htm", 1, 35)
);
...
var sNext="Avançar",sPrev="Voltar",sEnd="Finalizar apresentação",sFont="Arial"
function ShowMenu()
{
	BuildMenu();
