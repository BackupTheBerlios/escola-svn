 ...
 * TesteLogin.java
 *
 * Created on 27 de Julho de 2007, 17:38
 * Copyright pmelo
 */
...
public class Login extends AbstractPageBean {
    ...
    private PasswordField pwdSenha = new PasswordField();
    
    public PasswordField getPwdSenha() {
        return pwdSenha;
    }
    
    public void setPwdSenha(PasswordField pf) {
        this.pwdSenha = pf;
    }
     ...
     */
    public Login() {
        authenticationController = (AuthenticationController) EscolaServiceDelegate.getInstancia().obtemServico("authenticationController");
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("TesteLogin Initialization Failure", e);
    ...
    public String btnLogin_action() {
        return authenticationController.autenticar(txtUsuario.getText().toString(), pwdSenha.getText().toString());
    }
}