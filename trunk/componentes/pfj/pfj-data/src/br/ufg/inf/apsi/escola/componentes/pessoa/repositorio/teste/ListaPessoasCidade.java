...
/**
 * Classe definida para testar a listagem de pessoas por cidade.
 * @author gilmar
 *
 */
public class ListaPessoasCidade {
	/**
	 * 
	 * @param args
	 */
	public static void main(String args[]){
		...
		try {
			List<String> nomePessoas = ps.listaPessoasCidade("Aparecida de Goiânia");
