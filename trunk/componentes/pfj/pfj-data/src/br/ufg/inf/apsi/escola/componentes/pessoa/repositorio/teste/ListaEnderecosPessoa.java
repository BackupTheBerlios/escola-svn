...
/**
 * Classe definida para testar a listagem dos endereços da pessoa.
 * @author gilmar
 *
 */
public class ListaEnderecosPessoa {
	...
	public static void main(String[] args) {
		...
		try {
			List<String> listaNomeEnderecosPessoa = ps.listaEnderecosPessoa(1L);
			for (String s : listaNomeEnderecosPessoa){
