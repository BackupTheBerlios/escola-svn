...
/**
 * classe definida para testar o método consultaTodosDadosPessoa da interface PessoaService
 * @author gilmar
 *
 */
public class ConsultaTodosDadosPessoa {
	...
	public static void main(String[] args) {
		...
		try {
			System.out.println(ps.consultaTodosDadosPessoa(1L));
		} catch (PessoaNaoEncontradaException ee) {
			ee.printStackTrace();
