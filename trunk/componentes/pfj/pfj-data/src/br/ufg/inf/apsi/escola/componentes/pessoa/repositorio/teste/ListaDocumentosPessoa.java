...
/**
 * Classe definida para testar a consulta dos documentos da pessoa.
 * @author gilmar
 *
 */
public class ListaDocumentosPessoa {
	/**
	 * 
	 * @param args
	 */
	public static void main(String args[]){
		...
		try {
			List<String> listaDocumento = ps.listaDocumentosPessoa(1L);
			for (String s : listaDocumento){
