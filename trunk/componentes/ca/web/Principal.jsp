...
<%@page import="br.ufg.inf.apsi.escola.ie.acegi.UsuarioAutenticado"%>
<html>
<head>
...
<f:view>
	...
	<%
				UsuarioAutenticado u = (UsuarioAutenticado) SecurityContextHolder
	...
	<h:form>
		...
		<br>
		<br>
		<h:commandButton actionListener="#{principal.sair}" action="sair"
			id="btnSair" value="#{msg.exit}" />
	</h:form>
	</authz:authorize>
	</body>
</f:view>
