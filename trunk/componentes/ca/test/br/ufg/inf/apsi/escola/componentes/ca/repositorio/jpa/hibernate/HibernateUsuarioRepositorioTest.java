...
public class HibernateUsuarioRepositorioTest extends AbstractJpaTests {
	...
	/*
	 * public void testObterUsuarioComIdInvalido() { Usuario user = null; try {
	 * user = usuarioRepositorio.obterUsuario(9999); fail("Deveria lançar um
	 * UsuarioNaoEncontradoException!"); } catch (UsuarioNaoEncontradoException
	 * e) { assertNull(user); } catch (UsuarioException e) { } }
	 */
	...
	/*
	 * public void testObterUsuarioComUsernameInvalido() { Usuario user = null;
	 * try { user = usuarioRepositorio.obterUsuario("username invalido");
	 * fail("Deveria lançar um UsuarioNaopEncontradoException!"); } catch
	 * (UsuarioNaoEncontradoException e) { assertNull(user); } catch
	 * (UsuarioException e) { } }
	 */
	...
	public void testExcluirUsuario() {
		...
		try {
			usuarioRepositorio.excluirUsuario(userId1);
