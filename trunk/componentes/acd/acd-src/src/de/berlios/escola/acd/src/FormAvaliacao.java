...
public class FormAvaliacao {
	 ...
	 * 
	 * @param aluno
	 *            Instancia de <code>Aluno</code> para o qual se deseja criar
	 *            o <code>FormAvaliacao</code>.
	 */
	public FormAvaliacao(Aluno aluno) {
		this.aluno = aluno;
	}
	...
	/**
	 * Cria uma instancia de <code>FormAvaliacao</code> para o especificado
	 * <code>Aluno</code> e <code>Avaliacao</code>.
	 * 
	 * @param aluno
	 *            Instancia de <code>Aluno</code> para o qual se deseja criar
	 *            o <code>FormAvaliacao</code>.
	 ...
	 *            criar o <code>FormAvaliacao</code>.
	 */
	public FormAvaliacao(Aluno aluno, Avaliacao avaliacao) {
		this.aluno = aluno;
		this.avaliacao = avaliacao;
	}
	...
	/**
	 * Obtem o <code>Aluno</code> para qual se aplica o formulario de
	 * avaliacao.
	 * 
	 * @return o <code>Aluno</code> para qual se aplica o formulario de
	 *         avaliacao.
	 */
	...
	/**
	 * Atribui uma <code>Aluno</code> para o formulario de avaliacao.
	 * 
	 * @param aluno
	 *            <code>Aluno</code> para o qual se deseja criar o formulario
	 *            de avaliacao.
	 */
