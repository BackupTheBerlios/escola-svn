...
<body>
	<f:view>
		<h:form>
			...
			<br /><br />
			<h:inputText id="Pergunta" value="#{avaliacaoBean.pergunta}" required="true" size="30">Pergunta:&nbsp;&nbsp;&nbsp;</h:inputText>

			<br /><br />
			<h:message for="Pergunta" />

			<br /><br />
			<h:commandButton value="Cadastrar" action="#{avaliacaoBean.cadastrarQuestao}" />
