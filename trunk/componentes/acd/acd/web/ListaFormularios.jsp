...
<body>
	<f:view>
		<h:form>
			...
			<h:commandButton value="Selecionar Turma" action="#{formAvaliacaoBean.listarFormulariosAvaliacao}" />
			<br /><br />

			<h:dataTable value="#{formAvaliacaoBean.respostas}" var="r" border="0">
				<h:column>
					<f:facet name="header">
			...
			<br /><br />
			<h:commandLink value="Anterior" action="#{formAvaliacaoBean.anteriorFormAvaliacao}" />
			&nbsp;&nbsp;&nbsp;
			<h:commandLink value="Proximo" action="#{formAvaliacaoBean.proximoFormAvaliacao}" />
