...
public interface FormAvaliacaoRepository {
	...
	/**
	 * Recupera uma instancia de <code>Resposta</code> do banco de dados a
	 * partir de seu identificador.
	 * 
	 * @param respostaId
	 *            Identificador unico de <code>Resposta</code> para o banco de
	 *            dados.
	 * @return Uma instancia de <code>Resposta</code> do banco de dados.
	 */
	...
	/**
	 * Grava uma instancia de <code>Resposta</code> no banco de dados.
	 * 
	 * @param resposta
	 *            Uma instancia de <code>Resposta</code>.
	 * @return Retorna <code>false</code> caso haja algum erro.
	 */
	public boolean gravarResposta(Resposta resposta);

	/**
	 * Atualiza uma instancia de <code>Resposta</code> no banco de dados.
	 * 
	 * @param resposta
	 *            Uma instancia de <code>Resposta</code>.
	 * @return Retorna <code>false</code> caso haja algum erro.
	...
	/**
	 * Exclui uma instancia de <code>Resposta</code> no banco de dados.
	 * 
	 * @param resposta
	 *            Uma instancia de <code>Resposta</code>.
	 * @return Retorna <code>false</code> caso haja algum erro.
