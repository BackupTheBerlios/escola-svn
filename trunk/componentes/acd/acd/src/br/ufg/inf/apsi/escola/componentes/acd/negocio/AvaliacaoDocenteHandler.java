package br.ufg.inf.apsi.escola.componentes.acd.negocio;
...
/**
 * Esta interface oferece todos os servicos necessarios para uma camada
 * superior, como a de interacao com usuario trabalhar com a "Avaliacao do Corpo
 * Docente". Ela oferece servicos de manipulacao de <code>Avaliacao</code>,
 * <code>Questao</code>, <code>FormAvaliacao</code> e <code>Resposta</code>,
 * podendo persistir e recuperar esses objetos.
 * 
 * @author Rodrigo Morian Loures
 */
public interface AvaliacaoDocenteHandler {
	 ...
	 *            dados.
	 * @return Identificador unico da <code>Avaliacao</code> conforme
	 *         identificador da <code>Turma</code>.
	 */
	...
	/**
	 * Recupera o identificador unico de um <code>FormAvaliacao</code>.
	 * 
	 * @param avaliacaoId
	 *            Identificador unico de <code>Avaliacao</code> para o banco
	 *            de dados.
