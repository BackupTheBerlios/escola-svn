...
public class LocalServiceFactory implements ServiceFactory {
	...
	public AlunoService obterAlunoService() {
		...
		return (AlunoService) escolaServiceDelegate.obtemServico("localAlunoService");
	}

	public CursoService obterCursoService() {
		return (CursoService) escolaServiceDelegate.obtemServico("localCursoService");
	}

	public DisciplinaService obterDisciplinaService() {
		return (DisciplinaService) escolaServiceDelegate.obtemServico("localDisciplinaService");
	}

	public MatriculaTurmaService obterMatriculaTurmaService() {
		return (MatriculaTurmaService) escolaServiceDelegate.obtemServico("localMatriculaTurmaService");
	}

	public PreMatriculaDisciplinaService obterPreMatriculaDisciplinaService() {
		return (PreMatriculaDisciplinaService)escolaServiceDelegate.obtemServico("localPreMatriculaDisciplinaService");
	}

	public TurmaService obterTurmaService() {
		return (TurmaService) escolaServiceDelegate.obtemServico("localTurmaService");
	}
