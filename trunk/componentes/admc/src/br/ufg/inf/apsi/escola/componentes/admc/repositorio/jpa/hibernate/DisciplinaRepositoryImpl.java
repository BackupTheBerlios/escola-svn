 ...
 * 
 */
public class DisciplinaRepositoryImpl extends JpaDaoSupport implements
	...
	public Disciplina consultar(long id) throws Exception {
		Disciplina disciplina = (Disciplina) getJpaTemplate().find(
				Disciplina.class, Long.valueOf(id));
