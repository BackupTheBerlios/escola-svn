						...
						<table width="598" border="0" cellpadding="0" cellspacing="0"
							...
							<tr>
								<td width="598" height="26"
									...
									color="#FFFFFF">Cadastro Secretario </font></strong></td>
							...
							<tr>
								<td width="598" height="377" align="center" valign="top"
								 ...
								 <h:panelGrid columns="2" width="590">
									...
									<h:inputText  value="#{secretarioController.matricula}" size="15" />
									<h:outputText  value="Nome:" />
									<h:inputText id="nome" value="#{secretarioController.nome}" size="50" >
									   <f:validateLength minimum="2" maximum="200"/>
									   <h:message for="nome" showDetail="true"/>
									</h:inputText>
									<h:outputText value="Sexo:" />
									<h:selectOneMenu value="#{secretarioController.sexo}" >
										<f:selectItem itemValue="M" itemLabel="Masculino" />
										<f:selectItem itemValue="F" itemLabel="Feminino" />
									</h:selectOneMenu>
									<h:outputText value="Data Nascimento:" />
									<h:inputText id="datanascimento" value="#{secretarioController.dataNascimento}"
										size="12" >
									...
									<h:panelGrid columns="2">
										<h:inputText value="#{secretarioController.dddf1}" size="3">
										    
										</h:inputText>
										<h:inputText value="#{secretarioController.telefone1}" size="15" >
										     
										</h:inputText>
									</h:panelGrid>
								    <h:outputText value="Telefone Celular:" />
									<h:panelGrid columns="2">
										<h:inputText value="#{secretarioController.dddf2}" size="3" >
										  
										 </h:inputText> 
										<h:inputText value="#{secretarioController.telefone2}" size="15" >
										
										</h:inputText>
									</h:panelGrid>
									<h:outputText value="CPF:" />
									<h:inputText id="cpf" value="#{secretarioController.cpf}" size="15" >
									    <f:validator validatorId="cpfValidate"/>
									    <h:message for="cpf" showDetail="true"/>
									      
									</h:inputText>
									<h:outputText value="RG:" />
									<h:inputText value="#{secretarioController.rg}" size="15" />
									<h:outputText value="Data Emissão:" />
									<h:inputText value="#{secretarioController.dataEmissao}" size="12" >
									    <f:validator validatorId="dataValidate"/>
									</h:inputText>
									<h:outputText value="Órgão Expedidor:" />
									<h:inputText value="#{secretarioController.orgaoExpedidor}" size="6" />
									<h:outputText value="E-mail:" />
									<h:inputText value="#{secretarioController.email}" size="40" />
									<h:outputText value="Endereco Residencial:" />
									<h:inputText value="#{secretarioController.endereco}" size="60" />
									<h:outputText value="Numero:" />
									<h:inputText value="#{secretarioController.numero}" size="4" />
									<h:outputText value="Complemento:" />
									<h:inputText value="#{secretarioController.complemento}" size="50" />
									<h:outputText value="CEP:" />
									<h:inputText value="#{secretarioController.cep}" size="12" >
									    
									</h:inputText>
									<h:outputText value="Bairro:" />
									<h:inputText value="#{secretarioController.bairro}" size="50" />
									<h:outputText value="Cidade:" />
									<h:inputText value="#{secretarioController.cidade}" size="50" />
									<h:outputText value="Estado:" />
									<h:inputText value="#{secretarioController.estado}" size="3" />
									<h:outputText value="Pais:" />
									<h:inputText value="#{secretarioController.pais}" size="50" />
									<h:commandButton action="#{secretarioController.gravar}"
										value="Gravar" />
									<h:commandButton action="#{secretarioController.excluir}"
										value="Excluir" />
