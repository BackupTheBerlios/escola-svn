					...
					<tr>
						...
						<table width="598" border="0" cellpadding="0" cellspacing="0"
							...
							<tr>
								...
								<h:dataTable value="#{docenteController.todos}" var="item"
									styleClass="tbcomum" cellpadding="0" cellspacing="0"
									width="90%">
									<f:facet name="header">
										<h:outputText value="Docentes Cadastrados" />
									</f:facet>
									<h:column>
										<f:facet name="header">
									...
									<h:column>
										...
										<h:commandLink value="Editar"
											...
											action="#{docenteController.excluir}" />
									</h:column>

								</h:dataTable> <br />
								<h:commandLink value="Novo Docente"
									action="#{docenteController.novo}" /></td>
								<td><img
									src="<%=request.getContextPath()%>/images/spacer.gif" width="1"
