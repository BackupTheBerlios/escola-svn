						...
						<table width="598" border="0" cellpadding="0" cellspacing="0"
							...
							<tr>
								<td width="598" height="26"
									...
									color="#FFFFFF">Cadastro Docente </font></strong></td>
							...
							<tr>
								<td width="598" height="377" align="center" valign="top"
								 ...
								 <h:panelGrid columns="2" width="590">
									...
									<h:inputText  value="#{docenteController.matricula}" size="15" />
									<h:outputText  value="Nome:" />
									<h:inputText id="nome" value="#{docenteController.nome}" size="50" >
									   <f:validateLength minimum="2" maximum="200"/>
									   <h:message for="nome" showDetail="true"/>
									</h:inputText>
									<h:outputText value="Sexo:" />
									<h:selectOneMenu value="#{docenteController.sexo}" >
										<f:selectItem itemValue="M" itemLabel="Masculino" />
										<f:selectItem itemValue="F" itemLabel="Feminino" />
									</h:selectOneMenu>
									<h:outputText value="Data Nascimento:" />
									<h:inputText id="datanascimento" value="#{docenteController.dataNascimento}"
										size="12" >
									...
									<h:panelGrid columns="2">
										<h:inputText value="#{docenteController.dddf1}" size="3">
										    
										</h:inputText>
										<h:inputText value="#{docenteController.telefone1}" size="15" >
										     
										</h:inputText>
									</h:panelGrid>
								    <h:outputText value="Telefone Celular:" />
									<h:panelGrid columns="2">
										<h:inputText value="#{docenteController.dddf2}" size="3" >
										  
										 </h:inputText> 
										<h:inputText value="#{docenteController.telefone2}" size="15" >
										
										</h:inputText>
									</h:panelGrid>
									<h:outputText value="CPF:" />
									<h:inputText id="cpf" value="#{docenteController.cpf}" size="15" >
									    <f:validator validatorId="cpfValidate"/>
									    <h:message for="cpf" showDetail="true"/>
									      
									</h:inputText>
									<h:outputText value="RG:" />
									<h:inputText value="#{docenteController.rg}" size="15" />
									<h:outputText value="Data Emissão:" />
									<h:inputText value="#{docenteController.dataEmissao}" size="12" >
									    <f:validator validatorId="dataValidate"/>
									</h:inputText>
									<h:outputText value="Órgão Expedidor:" />
									<h:inputText value="#{docenteController.orgaoExpedidor}" size="6" />
									<h:outputText value="E-mail:" />
									<h:inputText value="#{docenteController.email}" size="40" />
									<h:outputText value="Endereco Residencial:" />
									<h:inputText value="#{docenteController.endereco}" size="60" />
									<h:outputText value="Numero:" />
									<h:inputText value="#{docenteController.numero}" size="4" />
									<h:outputText value="Complemento:" />
									<h:inputText value="#{docenteController.complemento}" size="50" />
									<h:outputText value="CEP:" />
									<h:inputText value="#{docenteController.cep}" size="12" >
									    
									</h:inputText>
									<h:outputText value="Bairro:" />
									<h:inputText value="#{docenteController.bairro}" size="50" />
									<h:outputText value="Cidade:" />
									<h:inputText value="#{docenteController.cidade}" size="50" />
									<h:outputText value="Estado:" />
									<h:inputText value="#{docenteController.estado}" size="3" />
									<h:outputText value="Pais:" />
									<h:inputText value="#{docenteController.pais}" size="50" />
									<h:outputText value="Curriculo:" />
									<h:inputTextarea cols="40" rows="15" value="#{docenteController.curriculo}"    />
									<h:commandButton action="#{docenteController.gravar}"
										value="Gravar" />
									<h:commandButton action="consultarDocentes"
										value="Cadastrados" />	
